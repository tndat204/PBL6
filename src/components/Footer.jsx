...
function Footer() {
  ...
  return (
    <footer className="bg-sea-400 text-white py-6 mt-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="text-gray-300 hover:text-white text-sm">Pages</a></li>
        ...
        <div>
          ...
          <p className="text-gray-300 text-sm">Email: support@itjobhunt.com</p>
          <p className="text-gray-300 text-sm">Phone: +1-800-123-4567</p>
          <p className="text-gray-300 text-sm">Address: 123 Job Street, Tech City</p>
